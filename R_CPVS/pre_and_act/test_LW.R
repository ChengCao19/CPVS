...
# LW = read.table("clipboard",header = TRUE)                                  # data2则来源于all_ep
# save(LW,file = "D:/Rproject/pre_and_act/LW.RData")
load("D:/Rproject/pre_and_act/LW.RData")
...
p1 = ggplot(data = LW, aes(x = length, y = LengthPre1)) +
  ...
  coord_fixed(ratio = 1, xlim = c(0, 10), ylim = c(0, 10))                    # 设置坐标轴范围
