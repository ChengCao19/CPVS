...
# Get the top two most frequent occurrence counts in the first segment
selected_varieties_segment1 = names(sorted_counts_segment1)[sorted_counts_segment1 %in% top2_counts_segment1]  
# Get the varieties with the top two highest occurrences in the first segment
...
# Get the top two most frequent occurrence counts in the second segment
selected_varieties_segment2 = names(sorted_counts_segment2)[sorted_counts_segment2 %in% top2_counts_segment2]  
# Get the varieties with the top two highest occurrences in the second segment
...
# Get the top two most frequent occurrence counts in the third segment
selected_varieties_segment3 = names(sorted_counts_segment3)[sorted_counts_segment3 %in% top2_counts_segment3]  
# Get the varieties with the top two highest occurrences in the third segment
selected_data_segment3 = segmented_dfs2[[3]][segmented_dfs2[[3]]$Variety %in% selected_varieties_segment3, ]  
# Filter the data corresponding to the top two most frequent varieties in the third segment

# Create variables to store the three segment data
final_segment1 = selected_data_segment1
final_segment2 = selected_data_segment2
final_segment3 = selected_data_segment3

# Get the variety names from final_segment1, final_segment2, and final_segment3
