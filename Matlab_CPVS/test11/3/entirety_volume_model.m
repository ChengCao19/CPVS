clear,clc;
% This file is used to varify evm.m
% Among the three functions, evm1 is the best, evm the second, evm2 the worst.

%% Call data and perform calculations

% datafilename = 'fixed_image_lab.xlsx';     % Data file and its name
% sheetname = 1;
...
for i = 1:height(data)
    ...
    [CV] = evm(len,wid);                     % Acquire Cotton boll volume
...
num = 3;
baseFolder = "D:\Rproject\line_chart_of_Volume_formulation\line_chart3\#";
...
efolder = "D:\Rproject\line_chart_of_Volume_formulation\line_chart3\Ep_evm2.xlsx";
